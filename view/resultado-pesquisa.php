...
<body>
            ...
            <div class="container-fluid maxWidth">
               ...
               <div class="mx-auto w-50 pesquisar-bar">
                <div class="input-group align-items-center">
                    <a href="https://bidcompras.com.br/view/home-usuario.php"><i class="material-icons pt-2 mr-2">home</i></a>
    ...
    <div class="wrapper col-lg-12 px-5">
        ...
        <nav id="sidebar">
            <div class="sticky">
                ...
                <!-- Sub header -->
                <p><a href="home-usuario.php" class="d-flex align-items-center"><i class="material-icons mr-2" style="font-size: 18px;">arrow_back</i> Voltar</a></p>
                <p class="border-top border-warning">
        ...
        <div id="content">          
            ...
            <div class="row">
                <!-- col-lg-10 -->
                <div class="container-fluid col-lg p-0 m-0">
                    <!-- Card structure -->
                    <!-- container-fluid -->
    ...
    <script src="../controller/js/verifica-url.js"></script>
    <script src="../controller/js/filtrar-resultados-pesquisa.js"></script>
    ...
    <script src="../controller/js/retorna-categoria-menu-resultado.js"></script>
    <script src="../controller/js/retorna-sub-categoria-menu.js"></script>
